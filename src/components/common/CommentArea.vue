    ...
    <div class="comment-input-wrapper">
      <div style="display:flex">
        ...
        <div style="width:100%" class="ml-3">
          ...
          <!-- 表情框 -->
          <EmojiFrame @addEmoji="addEmoji" :chooseEmoji="chooseEmoji"/>
        </div>
      </div>
    </div>
    <!-- 评论详情 -->
    <div v-if="count > 0 && reFresh">
      ...
      >
        ...
        <div class="comment-meta">
          ...
          <!-- 回复框 -->
          <ReplyFrame :type="type" ref="reply" @reloadReply="reloadReply"/>
        </div>
      </div>
      <!-- 加载按钮 -->
...
<script>
import ReplyFrame from "@/components/common/ReplyFrame";
  ...
  computed: {
    ...
    isLike() {
      return function (commentId) {
        ...
        return commentLikeSet == null
            ? "like"
            : commentLikeSet.indexOf(commentId) !== -1
                ? "like-active"
                : "like";
      };
    }
