...
<!--    </div>-->
    ...
    <div class="d-md-block d-none nav-container">
      ...
      <div class="float-right nav-title">
        ...
        <div class="menus-item">
          <router-link class="menu-btn" to="/friendlyLink">
            <i class="iconfont iconlianjie"/> 友链
          </router-link>
        </div>
        <div class="menus-item">
          <router-link class="menu-btn" to="/aboutMe">
            <i class="iconfont iconzhifeiji"/> 关于我
          </router-link>
        </div>
        <div class="menus-item">
          <router-link class="menu-btn" to="/messageBoard">
            <i class="iconfont iconpinglunzu"/> 留言板
          </router-link>
        </div>
        <div class="menus-item">
          <a
